<nav x-data="{ open: false }" class="bg-[#f6bb54] border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->user()->role === 'admin')
                        ...
                        {{-- RUTA CORREGIDA AQUÍ: admin.asistencias.index --}}
                    ...
                    {{-- BLOQUE EXCLUSIVO PARA TRABAJADOR --}}
                    @if(auth()->user()->role === 'user')
                        <x-nav-link :href="route('user.projects')" :active="request()->routeIs('user.projects')" class="text-green-800 font-bold">
                            {{ __('Mis Tareas') }}
                        </x-nav-link>
                    @endif
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        @if(auth()->user()->role === 'admin')
                            <x-dropdown-link :href="route('admin.reporte.hoy')" class="text-red-600 font-bold">
